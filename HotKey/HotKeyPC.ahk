...
+F9:: {
    Run '"C:\Users\segyn\AppData\Local\Programs\Opera GX\launcher.exe" "https://github.com/Seva5959?tab=repositories"'
}
...
^p:: {
    ...
    Click(25, 360)            ; Кликает по координатам в окне Яндекс Переводчика для ПК
