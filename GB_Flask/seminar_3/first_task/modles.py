...
# При создании столбиков db.Column можно выбрат 5 типов данных  инт-db.Integer стр db.String(228) Булл-db.Boolean флоат-db.Float время-db.DateTime и очень много другого
